...
# Install Ace Stream,
# Run first-time tasks for quicker boots.
...
RUN timeout 10s /opt/acestream/start-engine --client-console || echo "done"
...
CMD /opt/acestream/start-engine --use-ffmpeg=1 --client-console --bind-all
